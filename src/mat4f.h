...
// Computes an orthographic projection matrix given left, right, bottom, top, near, and far.
void mat4f_make_orthographic(mat4f_t* m, float left, float right, float bottom, float top, float near, float far);
